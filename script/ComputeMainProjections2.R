...
for (scen in c(1,4,6)) {
  ...
  save(GDPcapCC,file="data/output/projectionOutput/GDPcapCC_pooled_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput/GDPcapNoCC_pooled_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput/GlobalChanges_pooled_"%&%scens[scen]%&%"2.Rdata")
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput/GDPcapCC_richpoor_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput/GDPcapNoCC_richpoor_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput/GlobalChanges_richpoor_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput/GDPcapCC_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput/GDPcapNoCC_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput/GlobalChanges_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput/GDPcapCC_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput/GDPcapNoCC_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput/GlobalChanges_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
