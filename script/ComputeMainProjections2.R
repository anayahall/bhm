...
dir.create("data/output/projectionOutput2")
...
save(popProjections,file="data/output/projectionOutput2/popProjections.Rdata")
save(growthProjections,file="data/output/projectionOutput2/growthProjections.Rdata")

# Finally, read in projections of future temperature change, generated by the getTemperatureChange.R script
#   These are mean country level projections averaged across all CMIP5 models
Tchg2 <- read.csv("data/input/CCprojections/CountryTempChange_RCP85.csv")
Tchg2 <- merge(popProjections[[1]][,1:3],Tchg2,by.x="iso",by.y="GMI_CNTRY")
Tchg2 <- Tchg2[Tchg2$CNTRY_NAME%in%c("West Bank","Gaza Strip","Bouvet Island")==F,]
Tchg2 <- Tchg2$Tchg2 # just keep the vector of temperature changes, since sort order is now correct
...
dtm <- Tchg2   #the country-specific changes
...
for (scen in c(1,4,6)) {
  ...
  save(GDPcapCC,file="data/output/projectionOutput2/GDPcapCC_pooled_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput2/GDPcapNoCC_pooled_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput2/GlobalChanges_pooled_"%&%scens[scen]%&%"2.Rdata")
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput2/GDPcapCC_richpoor_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput2/GDPcapNoCC_richpoor_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput2/GlobalChanges_richpoor_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput2/GDPcapCC_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput2/GDPcapNoCC_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput2/GlobalChanges_pooled5lag_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
...
for (scen in c(1,4,6)) {
  ...
  GDPcapCC <- round(GDPcapCC,3) #round to nearest dollar
  GDPcapNoCC <- round(GDPcapNoCC,3)  #ditto
  save(GDPcapCC,file="data/output/projectionOutput2/GDPcapCC_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  save(GDPcapNoCC,file="data/output/projectionOutput2/GDPcapNoCC_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  save(tots,file="data/output/projectionOutput2/GlobalChanges_richpoor5lag_"%&%scens[scen]%&%"2.Rdata")
  GDPcapCC <- GDPcapNoCC <- NULL
  print(scen)
